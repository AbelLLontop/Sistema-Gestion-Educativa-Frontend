const Periodo = () => {
  return (
    <article className="w-64 h-36 bg-white rounded-md flex flex-col justify-center items-center cursor-pointer hover:shadow-xl transition-all hover:scale-105">
